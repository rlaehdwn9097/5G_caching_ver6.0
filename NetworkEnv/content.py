...
class Content(object):
    ...
    def update_validity(self, requested_date):
        setattr(self, 'requested_date', requested_date)
        setattr(self, 'expired_date', requested_date + cf.DELETE_PERIOD)

    def get_requested_date(self):
        return getattr(self, 'requested_date')

    def get_expired_date(self):
        return getattr(self, 'expired_date')
